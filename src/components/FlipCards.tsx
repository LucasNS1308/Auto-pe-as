...
const cards: { Icon: LucideIcon; title: string; desc: string; image: string }[] = [
  {
    Icon: Circle,
    title: 'Freios',
      ...
      <div className="container">
        ...
        >
          <h2 className="text-4xl md:text-6xl font-display mb-3">
            Categorias que fazem a <span className="text-gradient-rdf">diferença</span>
          </h2>
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-5">
          {cards.map((card, i) => (
            ...
            >
              {/* FRENTE: imagem com overlay escuro */}
              <div
              ...
              >
                ...
                <div className="absolute inset-0 flex items-center justify-center">
                  <card.Icon className="h-16 w-16 text-white opacity-80" />
                </div>
              </div>
              ...
              <div
                className="absolute bottom-0 left-0 right-0
                           bg-white border-t border-primary/20
